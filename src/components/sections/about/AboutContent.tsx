const AboutContent = () => {
  return (
    <div className="space-y-6 text-gray-600">
      ...
      <p className="leading-relaxed">
        Whether you need small retail packaging or bulk solutions like 15 kg, 50 kg, and 250 kg for industrial use, we have the flexibility and expertise to meet your requirements.
      </p>
      <p className="leading-relaxed">
        Indian Foodtech is proud to be certified with HALAL, ISO, and Foreign third party audit certificate, ensuring that our strict quality and food safety policies are upheld in every batch we produce.
      </p>
    </div>
  );
};
